  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <Tabs defaultValue="active" className="space-y-6">
          ...
          <TabsContent value="active">
            {ridesLoading ? (
              ...
              <EmptyState icon={Car} title="No active rides" description="Post a new ride to start." action={{ label: "Post a Ride", onClick: () => setLocation("/post-ride") }} />
            )}
          </TabsContent>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader><DialogTitle>Delete Ride?</DialogTitle><AlertDialogDescription>This cannot be undone.</AlertDialogDescription></AlertDialogHeader>
          <AlertDialogFooter>
